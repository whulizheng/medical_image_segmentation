...
class Model(nn.Module):
    def __init__(self, input_shape,patch_size = 8):
        ...
        self.down4 = MixStackEncoder(46,64,32,4)  # in: 32, out: 16
        self.down5 = MixStackEncoder(64,128,16,4) # in: 16, out: 8
        
        self.center = ConvBlock(128,128,kernel_size=(3,3),padding=1)# in: 8, out: 8
        
        self.up5 = MixStackDecoder(128,128,64,16,4) # in: 8, out: 16
        self.up4 = MixStackDecoder(64,64,46,32,4)# in: 16, out: 32
...
class MixStackEncoder(nn.Module):
    def __init__(self, channel1, channel2,img_size, patch_size,kernel_size=(3, 3), padding=1):
        super(MixStackEncoder, self).__init__()
...
class MixStackDecoder(nn.Module):
    def __init__(self, big_channel, channel1, channel2, img_size, patch_size,kernel_size=(3, 3), padding=1):
        super(MixStackDecoder, self).__init__()
        self.block = nn.Sequential(
